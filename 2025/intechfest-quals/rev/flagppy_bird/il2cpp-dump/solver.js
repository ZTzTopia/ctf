  ...
  setTimeout(() => {
    frida_java_bridge_default.enumerateLoadedClasses({
      ...
      onComplete: () => {
        ...
        Interceptor.attach(m.base.add(7165024), {
          onEnter(args) {
