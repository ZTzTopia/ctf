...
The image is named `dashcam_capture_20180811`. The image shows a fish and a date `20180811`. The date is in the format `YYYYMMDD`. The date is `2018-08-11`.
...
The GPS coordinates are `18.540433, 73.832317`. We can use these coordinates to find the location of the image. The coordinates are in Pune, Maharashtra, India.

The image shows a fish. The fish is a symbol of the `Phishing` attack. The organization that was attacked is `Cosmos Bank`. The year of the attack is `2018`. The amount of money stolen is `94` crore rupees.

## Flag

`QUESTCON{cosmos-2018-94}`
